...
DATASETS = {
    ...
    'pascal_parts_heads': {
	IM_DIR:
            _DATA_DIR + '/PASCAL_PARTS_HEADS/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/PASCAL_PARTS_HEADS/annotations/PascalVOC10Parts_coco.json'
    },
    'scuthead_a': {
	IM_DIR:
            _DATA_DIR + '/SCUTHEAD_A/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/SCUTHEAD_A/annotations/SCUTHEADA_coco.json'
    },
    'scuthead_b': {
	IM_DIR:
            _DATA_DIR + '/SCUTHEAD_B/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/SCUTHEAD_B/annotations/SCUTHEADB_coco.json'
    },
    'voc_2007_trainval': {
        IM_DIR:
